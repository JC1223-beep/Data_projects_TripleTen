...
| 5 | [Shopify](Shopify) | Built an interactive Power BI dashboard using public data scraped from the Shopify App Store. Analyzed app performance, developer responsiveness, and customer reviews across 2017–2020. Delivered insights on user engagement, seasonal revenue trends, and recommendations to improve app success. |
| 6 | [Zuber](https://github.com/JC1223-beep/Data_projects_TripleTen/tree/main/Zuber) | WORK IN PROCESS |
